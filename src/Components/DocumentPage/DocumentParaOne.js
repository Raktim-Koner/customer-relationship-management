    ...
    <div>
        <DocumentCard>
          ...
          <p className="text-black bg-slate-50 "> 
                   <p className="font-bold font-serif "> 1.Introduction<br /></p>
                    • Briefly explain what the CRM does and who it's for.
                    <br />
                   <p className="font-bold font-serif "> 2. Getting Started<br /></p>
                      • Login/Signup – How to log in or create an account.<br />
                      • Dashboard Overview – Key sections (e.g., Deals, Contacts, Projects, Reports).
                    <br />
                    <p className="font-bold font-serif ">3.Core Features & Quick Actions</p>
                   ...
                   <p className="font-bold font-serif "> 4.Search and Filters<br /></p>
                       • Advanced search techniques<br />
                       • Creating and saving custom filters<br />
                       • Using tags and categories effectively<br />
                   <p className="font-bold font-serif "> 5.Troubleshooting</p>
